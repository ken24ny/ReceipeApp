...
class MealDetailViewController: UIViewController {
    ...
    func getMealDetail() {
        model.getData(url: Constants.MEAL_DESCRIPTION_URL, id: meal!.idMeal, type: MealDetail.self) { result  in
            switch result {
...
//        model.getMealDetail(withID: meal!.idMeal){ [weak self] data in
